    ...
    public class BundleConfig {
        ...
        public static void RegisterBundles(BundleCollection bundles) {
            ...
            bundles.Add(new StyleBundle("~/Content/GridMvcCss").Include(
                                        "~/Content/Gridmvc.css"));
            bundles.Add(new ScriptBundle("~/bundles/GridMvcScript").Include(
                                         "~/Scripts/gridmvc.js"));

            bundles.Add(new StyleBundle("~/Content/DatePickerCss").Include(
                                        "~/Content/bootstrap-datepicker.css"));
            bundles.Add(new ScriptBundle("~/bundles/DatePickerScript").Include(
                                         "~/Scripts/bootstrap-datepicker.js", 
                                         "~/Scripts/locales/bootstrap-datepicker.pt-BR.js"));

            bundles.Add(new ScriptBundle("~/bundles/UtilsScript").Include(
                             "~/Scripts/Utils.js"));
        }
    }
}
